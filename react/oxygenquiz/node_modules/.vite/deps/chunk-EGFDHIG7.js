...
var Grow = React4.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children,
  ...
  const timer = React4.useRef();
  const autoTimeout = React4.useRef();
  const theme = useTheme();
...
true ? Grow.propTypes = {
   ...
   * @default 'auto'
   */
  timeout: import_prop_types4.default.oneOfType([import_prop_types4.default.oneOf(["auto"]), import_prop_types4.default.number, import_prop_types4.default.shape({
...
var _excluded5 = ["children", "className", "component", "dense", "disablePadding", "subheader"];
...
var List = React5.forwardRef(function List2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return (0, import_jsx_runtime6.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime5.jsxs)(ListRoot, _extends({
      as: component,
...
var _excluded6 = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
...
var MenuList = React6.forwardRef(function MenuList2(props, ref) {
  ...
  const textCriteriaRef = React6.useRef({
    keys: [],
    repeating: true,
  ...
  React6.useImperativeHandle(actions, () => ({
  ...
  React6.Children.forEach(children, (child, index) => {
  ...
  const items = React6.Children.map(children, (child, index) => {
  ...
  return (0, import_jsx_runtime7.jsx)(List_default, _extends({
    role: "menu",
    ref: handleRef,
    className,
...
true ? MenuList.propTypes = {
   ...
   * @default false
   */
  autoFocusItem: import_prop_types6.default.bool,
  /**
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EGFDHIG7.js.map
